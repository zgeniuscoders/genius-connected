<div class="bg-dark text-gray-100 px-4 py-4 h-full fixed w-300 border-r border-dark-secondary">
    <h3 class="text-xl font-bold text-blue-700">GENIUS CONNECTED</h3>

{{--    <img src="{{ asset("images/dot.png") }}" class="absolute bottom-0 left-0">--}}

    <div class="pt-4 relative">
        <h4 class="after:absolute after:block after:content-[''] after:border-b after:w-full after:my-2 mb-4">Vos
            jeux</h4>
        <p class="w-full bg-dark-secondary/30 backdrop-blur-sm p-4 rounded uppercase text-sm">
            <a href="" class="flex items-center">
                <i class="fa fa-play"></i>
                <span class="pl-4">entrainement</span>
            </a>
        </p>
    ...
    <div class="pt-4 relative">
        <h4 class="after:absolute after:block after:content-[''] after:w-full after:border-b after:my-2 mb-4">
            Menu</h4>
        <ul>
            <li class="flex items-center md:hover:text-blue-700 mb-4">
