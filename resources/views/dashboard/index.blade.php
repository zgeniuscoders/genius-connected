...
@section("main")
    <div class="grid grid-cols-custom relative">
        <section>
            <div class="px-8 rounded relative bg-blue-700  h-300 m-4 rounded-lg flex items-center">
                <div class="text-gray-100">
                    <h2 class="text-xl font-bold uppercase">Get up to 80 brains</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi, temporibus.</p>
                    <p class="mt-4">
                        <a href="" class="bg-blue-300 px-4 py-2 text-gray-100 rounded-lg mt-8">Get started</a>
                    </p>
                </div>
            </div>
            <main class="mx-4 dark:text-gray-100">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="" class="text-blue-700">voir tout</a>
                </div>
