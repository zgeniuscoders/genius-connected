...
<nav
    class="bg-white px-2 sm:px-4 py-2.5 dark:bg-dark-secondary fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
...
{{--        app logo--}}
        ...
        <div class="md:flex items-center justify-between w-full md:flex md:w-auto md:order-1 hidden" id="navbar-sticky">
            <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-dark-secondary dark:border-gray-700">
                <li>
                    <a href="#"
