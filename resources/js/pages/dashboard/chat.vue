...
<!--                    <img src="{{ asset("images/avatar.png") }}" alt="username" class="w-60 h-60">-->
            ...
            <aside class="border-l border-dark-secondary px-2 h-90vh overflow-auto">
                <form action="" class="w-full mb-2 pt-2">
                    <label>
                        <input type="search" name="q" placeholder="Recherche..." class="w-full dark:bg-dark-secondary dark:text-gray-100 rounded-md p-2 outline-none">
                    </label>
                </form>
                <a href="" class="flex items-center text-gray-100 bg-dark-secondary rounded-md p-2 mb-2">
                    <div class="flex items-center w-full">
<!--                        <img src="{{ asset("images/avatar.png") }}" alt="username" class="w-40 h-40">-->
                        <div class="ml-4">
                            <h3 class="text-sm">Zgenius Coders</h3>
